...
const MOCKED_QUERY_URL = 'https://api.mercadolibre.com/sites/MLB/search?category=MLB1072&q=pedigree&limit=5';

afterEach(cleanup);

describe('Sugestions component and children', () => {
  it('should render a card item after have called global fetch', async () => {
    ...
    renderWithRouterAndStore(<Sugestions />, { route: '/' }, mockedShoppingCart);
