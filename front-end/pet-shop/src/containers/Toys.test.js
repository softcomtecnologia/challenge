...
const MOCKED_QUERY_URL = 'https://api.mercadolibre.com/sites/MLB/search?category=MLB1072&q=Brinquedos&limit=5';

afterEach(cleanup);

describe('Toys component and children', () => {
  it('should render a card item after have called global fetch', async () => {
    ...
    renderWithRouterAndStore(<Toys />, { route: '/' }, mockedShoppingCart);
